document.addEventListener('DOMContentLoaded', () => {
    ...
    // Funções de controle da playlist de música
    ...
    // Função para atualizar os estilos da grade e das peças
    ...
    // 1. Criar as peças do quebra-cabeça
    ...
    // 2. Criar os espaços no tabuleiro
    ...
    // 4. Funções para o arrastar e soltar
    ...
    function checkWin() {
        ...
        if (isSolved) {
            ...
            confettiCanvas.style.zIndex = '1001'; // Acima da tela de vitória
            ...
            // Remove o canvas de confetes após alguns segundos
            setTimeout(() => {
    ...
    // Lógica para a Modal de Imagem Ampliada
    ...
    // Lógica para a Modal de Instruções/Ajuda
    ...
    // Funções de seleção de dificuldade
    const easyBtn = document.getElementById('easy-btn');
    const mediumBtn = document.getElementById('medium-btn');
    const hardBtn = document.getElementById('hard-btn');
    const difficultyButtons = [easyBtn, mediumBtn, hardBtn]; // Re-declarado aqui, pode ser no início
